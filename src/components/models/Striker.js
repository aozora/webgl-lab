...
const Striker = React.forwardRef((props, ref) => {
  // const group = useRef();
  // const mesh = useRef();
  const { nodes, materials } = useGLTF('/glb/sci-fi/Striker.gltf');
  ...
  return (
    <group {...props} dispose={null}>
      <mesh ref={ref} castShadow receiveShadow geometry={nodes.Striker.geometry} material={materials.Texture} />
    </group>
  );
});
...
useGLTF.preload('/glb/sci-fi/Striker.gltf');
